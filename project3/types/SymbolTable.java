...
public class SymbolTable {
    ...
    public ClassContents getFieldClassContents (String id, String class_name, String method_name) {
        ClassContents current_class_contents = symbol_table.get(class_name);
        if (current_class_contents == null) {
            System.err.println("Cannot find class " + class_name + " in symbol table, identifier: " + id);
            return null;
        ...
        if (method_contents.parameters.containsKey(id)) return null;
        if (method_contents.variables.containsKey(id)) return null;

        if (current_class_contents.fields.containsKey(id)) return current_class_contents;
